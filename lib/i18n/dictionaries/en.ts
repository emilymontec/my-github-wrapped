...
export const en = {
  ...
  dashboard: {
    ...
    syncButtonIdle: "Sync now",
    syncButtonActive: "Syncing…",
    syncGenericError: "Sync failed.",
    syncLastSynced: "Last synced: {when}",
    syncNeverSynced: "Syncing your activity for the first time…",
    syncRefreshAria: "Sync now",
  ...
  wrapped: {
    ...
    generatingSteps: [
      ...
      "Calculating your coding rhythm…",
      "Mapping out your languages…",
      "Writing your insights…",
      "Almost there…"
    ],
    generateSlowWarning: "This is taking longer than usual — we're still working on it, no action needed.",
    generateCheckNow: "Check now",
